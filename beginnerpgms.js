...
// //working with alert,prompt and change the url
// let inp =prompt('enter your age');
// if (inp>18){
//     alert('you can drive!!!');
// }else if(inp<0){
//     console.error(inp,'negative value');
//     console.warn(inp,'enter the positive value');
// }else{
//     alert('ypu cannot drive');
// }
...
// li.innerText='i am li one';
// li2.innerText='i am li two';
...
function addElement(){
    ...
    const newText=document.createTextNode('this is created div tags text!!');
